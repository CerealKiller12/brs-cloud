@extends('layouts.app', ['title' => 'Registro | BRS Cloud'])

@section('content')
<div class="login-wrap">
    <div class="login-card">
        <small class="eyebrow">Registro cloud</small>
        <h1>Crea tu espacio en BRS Cloud</h1>
        <p>Al registrarte generamos tu tenant, tu store principal y el usuario owner inicial para empezar a conectar cajas.</p>
        ...
        <div class="surface" style="margin-top: 24px;">
            ...
            <p>1. Creamos tu tenant.</p>
            <p>2. Creamos la store <strong>Caja principal</strong>.</p>
            <p>3. Te dejamos como owner para administrar catalogo, devices y sincronizacion.</p>
        </div>
